...
# **🎯 Pergunta clássica de entrevista DevOps**

**Pergunta**

How do you discover runtime dependencies of a Linux binary?

Resposta:

Using `ldd` to inspect the shared libraries required by the binary.

---

💡 Se quiser, posso te mostrar também:

* **como criar uma imagem Node de apenas \~35MB**  
* **como reduzir sua imagem atual de 120MB para 25MB**  
* **como empresas como Netflix e Google otimizam imagens Docker**

Isso é **uma das habilidades mais valorizadas em DevOps/Kubernetes.**
